...
async function runChat(userInput) {
  ...
  const chat = model.startChat({
    ...
    history: [
        {
          role: "user",
          parts: [{ text: "You are a chatbot, a friendly assistant who can answer questions and provide information regarding the diseases identified the Dr.Derm App. You should only answer questions related to the diseases identified by the app,for any other questions, give a suitable prompt saying you don't know, also mention that results are not always 100% accurate and advise users to consult medical professionals from time to time" }],
        },
        {
          role: "user",
...
const chatbotController = async (req, res) => {
  try {
    ...
    //console.log('Incoming chatbot request:', userInput);
